...
class Num4ViewController: UIViewController {
    ...
    @IBOutlet weak var bottomingActivateView: UIView!
     ...
     var closeNum4VCBlock: (() -> Void)?
     func closeNum4(_ block: @escaping () -> Void) {
         closeNum4VCBlock = block
     }
    ...
    @objc func tap1Action(){
        ...
        UIView.animate(withDuration: 0.3,
                       ...
                       completion: { Void in()
                        ...
                        let vc = MountainsViewController(nibName: nil, bundle: nil)
