...
//    var theme_cursorColor: ThemeColorPicker? {
...
//
//extension NumberPad {
//    var theme_mainColor: ThemeColorPicker? {
//        get { return getThemePicker(self, "setColor:") as? ThemeColorPicker }
//        set { setThemePicker(self, "setColor:", newValue) }
//    }
//}
...
//
//extension MiscPanel {
//    var theme_backColor: ThemeColorPicker? {
//        get { return getThemePicker(self, "setBackColor:") as? ThemeColorPicker }
//        set { setThemePicker(self, "setBackColor:", newValue) }
//    }
//    
...
//}
//
//extension OrderEntryPanel {
//    var theme_color: ThemeColorPicker? {
//        get { return getThemePicker(self, "setColor:") as? ThemeColorPicker }
//        set { setThemePicker(self, "setColor:", newValue) }
//    }
//    
//    var theme_bottomBackColor: ThemeColorPicker? {
//        get { return getThemePicker(self, "setBottomBackColor:") as? ThemeColorPicker }
//        set { setThemePicker(self, "setBottomBackColor:", newValue) }
//    }
//}
//
//extension SeatIcon {
...
extension UIButton
{
    public func theme_setImage(_ picker: ThemeImagePicker, forState state: UIControl.State) {
        let statePicker = makeStatePicker(self, "setImage:forState:", picker, state)
        setThemePicker(self, "setImage:forState:", statePicker)
    }
    public func theme_setBackgroundImage(_ picker: ThemeImagePicker, forState state: UIControl.State) {
    ...
    public func theme_setTitleColor(_ picker: ThemeColorPicker, forState state: UIControl.State) {
