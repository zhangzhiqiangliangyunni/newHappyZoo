...
extension NSObject {
    ...
    func performThemePicker(_ selector: String, picker: ThemePicker?) {
        ...
        if let statePicker = picker as? ThemeStatePicker {
            ...
            statePicker.values.forEach { setState(self, sel, $1.value()!, $0) }
        }
    ...
    fileprivate typealias setValueForStateIMP       = @convention(c) (NSObject, Selector, AnyObject, UInt) -> Void
